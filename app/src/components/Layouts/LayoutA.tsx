...
// Component for Layout_A
export default function LayoutA({ features, price, token, id, name, category, description}: LayoutAProps){

    return(
        <div className="box-item card my-2 bg-info">
