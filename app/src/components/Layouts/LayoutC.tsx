...
// Component for Layout_C
export default function LayoutC({ features, price, token, id, name, category, description}: LayoutAProps){

    return(
        <div className="box-item card my-2 bg-danger">
