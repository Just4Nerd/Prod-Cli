...
// Component for Layout_D
export default function LayoutD({ features, price, token, id, name, category, description}: LayoutAProps){

    return(
        <div className="box-item card my-2 bg-success">
